...
import { deleteFromCart } from '../../reducers/basket-reducer';

function BasketItem ({id, idx, img, title, price, handleLink}) {
    ...
    return (
        <div className='Cart-item' onClick={handleLink}>
            ...
            <button onClick={handleDelete} className='Cart-delete-btn'>
